...
$('document').ready(function(){
		...
		$(window).resize(function(){
			...
			$('#b01').animate({top:140, left: vw-150},500);
			$('#b22').animate({top:140, left: vw-50},500);
			$('#b33').animate({top:140, left: vw+50},500);
			$('#b44').animate({top:140, left: vw+150},500);
			$('#b55').animate({top:240, left: vw-180},500);
			$('#b66').animate({top:240, left: vw-80},500);
			$('#b77').animate({top:240, left: vw+0},500);
			$('#b88').animate({top:240, left: vw+80},500);
			$('#b99').animate({top:240, left: vw+180},500);
			$('#b100').animate({top:340, left: vw-150},500);
			$('#b111').animate({top:340, left: vw-50},500);
			$('#b122').animate({top:340, left: vw+50},500);
			$('#b133').animate({top:340, left: vw+150},500);	
			});
